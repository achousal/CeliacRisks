...
from ced_ml.config.schema import SplitsConfig, TrainingConfig, CVConfig
from ced_ml.config.loader import load_splits_config, apply_overrides
...
def test_apply_overrides_nested():
    ...
    config_dict = {
        "cv": {"folds": 5, "repeats": 3},
        "features": {"screen_top_n": 0}
    }
